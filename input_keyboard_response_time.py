...
#return bool_is_vaild_key_up_list of the input_list
...
#judge whether the data of key up test is right,including the keyboard_type and the input_list
#operate based on input_list_file[2,2] to get the ten true is_vaild_key_up_list()
...
def get_config(project_name):
    ...
    return module_config #the data_return is a dict;
...
#the main function to get result with inputdata, picture and video &mechine learning model
def get_result(cand_model, pinyin_model, is_vaild_key_up_list, video_path, resultPath, input_name, input_version, input_list):
    config = get_config('sogou_input_response_time')#to get the mechine learning CNN's parameters.
...
#it's useful to know its function and return value
...
if __name__ == '__main__':
    ...
    input_version = ''
    keyboard_type = 9
    input_list_file = './test'
    resultPath = './result/'
    video_path = 'test_data/video/820_2.MOV'
